...
public class MatchFilterDialog extends DialogFragment
{
    ...
    private void setupFilters()
    {
        ...
        binding.eventOptions.setOnFocusChangeListener((v, focus) -> {
            if (focus)
            {
                binding.eventOptions.showDropDown();
            }
        });
        ...
        binding.teamOptions.setOnFocusChangeListener((v, focus) -> {
            if (focus)
            {
                binding.teamOptions.showDropDown();
            }
        });
        ...
        binding.scoutOptions.setOnFocusChangeListener((v, focus) -> {
            if (focus)
            {
                binding.scoutOptions.showDropDown();
            }
        });
    }
    ...
    private void applyFilters()
    {
        ...
        String event = binding.eventOptions.getText().toString().trim();
        if (!event.isEmpty())
        {
